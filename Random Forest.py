...
if train_acc - test_acc > 0.05:  # Threshold of 0.05, can be adjusted
...
plot_tree(chosen_tree, filled=True, feature_names=X.columns, class_names=['Not Fallen', 'Fallen'], rounded=True)
plt.show()
